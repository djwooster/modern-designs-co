      ...
      <div className="mx-auto max-w-[1400px]">
        <FadeIn className="mb-10">
          ...
          <p className="text-base text-muted-foreground leading-relaxed">
            Modern Designs Co was built on one belief: that startups and growing
            businesses deserve the same quality of product design and development
            that top-tier companies get. We&apos;re a small, focused studio —
            which means every project gets real attention, not just hours billed.
          </p>
        </FadeIn>

        <FadeInStagger className="flex flex-col gap-4 mt-10" staggerDelay={0.1}>
          {values.map((value) => (
            <motion.div
              key={value.label}
